...
class Animation {
   ...
   */
  public inline function getFrame(time: Float): AtlasFrame {
   ...
   */
  public inline function getFrameName(time: Float): String {
   ...
   */
  public inline function finished(time: Float): Bool {
    if (playMode == LOOP || playMode == LOOP_REVERSED || playMode == PING_PONG) {
      return false;
    }
